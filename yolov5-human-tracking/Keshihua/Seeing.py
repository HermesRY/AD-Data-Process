...
def main():
    ...
    #data_path = 'S003C002P002R002A047.skeleton'  # 喝水skeleton文件名
    data_path = 'S002C001P010R001A002.skeleton' # 握手skeleton文件名
...
data_path = 'S002C002P013R002A039.skeleton'
#data_path = 'S002C001P010R001A002.skeleton'
#data_path = 'S003C002P002R002A047.skeleton'
...
zmax = np.max(point[2, :, :, :]) + 0.2
zmin = np.min(point[2, :, :, :]) - 0.2
...
#ax.scatter(point[0, i, :, :], point[1, i, :, :], point[2, i, :, :], c='red', s=40.0)
#ax.plot(point[0, i, arms, 0], point[1, i, arms, 0], point[2, i, arms, 0], c='green', lw=2.0)
#plt.show()
...
for i in range(n, m):
    ...
    ax.scatter(point[0, i, :, :], point[1, i, :, :], point[2, i, :, :], c='red', s=40.0)
    ax.plot(point[0, i, arms, 0], point[1, i, arms, 0], point[2, i, arms, 0], c='green', lw=2.0)
    ax.plot(point[0, i, rightHand, 0], point[1, i, rightHand, 0], point[2, i, rightHand, 0], c='green', lw=2.0)
    ax.plot(point[0, i, leftHand, 0], point[1, i, leftHand, 0], point[2, i, leftHand, 0],c='green', lw=2.0)
    ax.plot(point[0, i, legs, 0], point[1, i, legs, 0], point[2, i, legs, 0],c='green', lw=2.0)
    ax.plot(point[0, i, body, 0], point[1, i, body, 0], point[2, i, body, 0],c='green', lw=2.0)

    ax.plot(point[0, i, arms, 1], point[1, i, arms, 1], point[2, i, arms, 1],c='green', lw=2.0)
    ax.plot(point[0, i, rightHand, 1], point[1, i, rightHand, 1], point[2, i, rightHand, 1], c='green', lw=2.0)
    ax.plot(point[0, i, leftHand, 1], point[1, i, leftHand, 1], point[2, i, leftHand, 1], c='green', lw=2.0)
    ax.plot(point[0, i, legs, 1], point[1, i, legs, 1], point[2, i, legs, 1], c='green', lw=2.0)
    ax.plot(point[0, i, body, 1], point[1, i, body, 1], point[2, i, body, 1], c='green', lw=2.0)

    ax.text(xmax - 0.5, ymax - 0.1, zmax - 0.1, 'frame: {}/{}'.format(i, row - 1))
